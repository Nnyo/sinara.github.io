...
self.addEventListener('install',(event) =>{
    ...
    const respCache = caches.open(STATIC_CACHE_NAME).then((cache) =>{
        return cache.addAll(
            [
                'sinara.github.io/',
                'sinara.github.io/index.html',
                'sinara.github.io/js/app.js',
                'sinara.github.io/js/main.js',
                'sinara.github.io/manifest.json',
                'sinara.github.io/SINARA_login.html',
                'sinara.github.io/views/SINARA_producto.html',
                'sinara.github.io/css/style_login.css',
                'sinara.github.io/css/toast.min.css',
                'sinara.github.io/css/bootstrap.min.css',
                'sinara.github.io/css/style.css',
                'sinara.github.io/images/SINARA.ico',
                'sinara.github.io/images/bg-icon.png',
                'sinara.github.io/images/SINARA.png',
                'sinara.github.io/images/bg.png',
                'sinara.github.io/images/icons/android-launchericon-144-144.png',
                'sinara.github.io/js/config.js',
                'sinara.github.io/js/function/usuarios_functions.js',
                'sinara.github.io/js/function/products_functions.js',
                'sinara.github.io/js/function/logout_functions.js',
                'sinara.github.io/js/function/donations_functions.js',
                'sinara.github.io/js/function/camera.js',
                'sinara.github.io/js/request/login.js',
                'sinara.github.io/js/request/donation.js',
                'sinara.github.io/js/request/logout.js',
                'sinara.github.io/js/request/product.js',
                'sinara.github.io/js/toast.min.js',
                'sinara.github.io/js/validate.js'
            ]
        );
    });
