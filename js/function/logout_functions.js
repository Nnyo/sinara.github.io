...
const loadMenu = async ()=>{
    ...
    if(localStorage.getItem('role') == 'Admin'){
        menuByRol = '<a href="/views/Administrador/almacen.html" class="nav-item nav-link">Almacen</a>'+
                    '<a href="/views/Administrador/cadenas.html" class="nav-item nav-link">Cadenas</a>'+
                    '<a href="/views/Administrador/donaciones.html" class="nav-item nav-link">Donaciones</a>'+
                    '<a href="/views/Administrador/productos.html" class="nav-item nav-link">Productos</a>'+
                    '<a href="/views/Administrador/usuarios.html" class="nav-item nav-link">Usuarios</a>';
    }else if(localStorage.getItem('role') == 'Recolector'){
        menuByRol = '<a href="/index.html" class="nav-item nav-link active">Inicio</a>';
    }
    document.getElementById('containerMenu').innerHTML =
        ...
        '<nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">'+
            '<a href="#" class="navbar-brand ms-4 ms-lg-0">'+
                '<img src="/images/SINARA.ico" width="30%" alt="">'+
            '</a>'+
